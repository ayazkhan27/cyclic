...
def measure_khan_encryption(plaintext):
    ...
    # Print char-to-movement and movement-to-char mappings
    print("Char to Movement Mapping:")
    print(char_to_movement)
    print("Movement to Char Mapping:")
    print(movement_to_char)

    # Print ciphertext and decrypted plaintext
    print("Ciphertext:")
    print(ciphertext)
...
# Check char_to_movement dictionary
print("Movement for character 'b' during encryption:", char_to_movement['b'])
print("Decrypted movement corresponding to character 'b':", movement_to_char[char_to_movement['b']])
